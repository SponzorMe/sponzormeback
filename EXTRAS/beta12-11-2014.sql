...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2014 a las 00:02:37
...
(38, 'Correr por la casa', 'Av 40 Diag 55-98, Medellin, Antioquia', '2014-12-09 05:00:00', 9, '', 'test', 0, 0, '2014-11-05 00:18:35', '2014-11-05 00:18:35', 1, '2014-12-09 05:00:00');
...
CREATE TABLE IF NOT EXISTS `web_users` (
  ...
  `meetupRefreshKey` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `web_users` (`id`, `email`, `password`, `permissions`, `activated`, `activation_code`, `activated_at`, `last_login`, `persist_code`, `reset_password_code`, `company`, `created_at`, `updated_at`, `name`, `country`, `state`, `city`, `sex`, `age`, `custom_status`, `login_code`, `login_valid_until`, `lang`, `image`, `description`, `eventbriteKey`, `meetupRefreshKey`, `comunity_size`) VALUES
(9, 'seagomezar@gmail.com', '$2y$10$U9DaIer6eI/HrN4eIYLnCeUSfx3SIta5EihVy83z5fFs9Mg568e62', NULL, 1, NULL, '2014-10-15 01:15:15', '2014-11-12 21:49:16', '$2y$10$a.5qcfcuSBys6hJfpxuTZuVuR9Ev3UNG03FjEKT5XTPLEynj3NjRO', NULL, 'SponzorMe', '2014-10-15 00:37:45', '2014-11-13 01:27:47', 'Sebastian Alonso Gomez Arias', 'Colombia', 'Atlantico', 'Baranoa', 1, 23, 2, NULL, NULL, '', '', 'Backend Developer', 'TIOA74GPG66V4CTL2PD2', '33015b8a452a84fbc2967e5d55f15461', 0),
(11, 'sebastian.gomez@sponzor.me', '$2y$10$woZ/ImDxNUzU/An9fsCFq.nsGmf6QqN34eTXBmA87Mu2bMEXiKUI2', NULL, 1, NULL, '2014-10-15 01:50:01', '2014-10-30 01:39:11', '$2y$10$SFjKuMDQPMaGy4oOaL11xuRWTndMdznMt4NGkKbca4.U5fHvmndFe', NULL, 'Sponzorme', '2014-10-15 01:46:53', '2014-10-30 01:39:11', 'Sebastian Gomez', 'Colombia', 'Medellin', 'Bello', 1, 23, 2, NULL, NULL, '', '', 'Admin of Sponzorme', '', '', 0);
